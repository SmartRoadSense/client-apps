...
namespace SmartRoadSense.Resources {
    ...
    public class LogStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Synchronization completed ({0} files uploaded).
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Synchronization completed (1 file uploaded).
        /// </summary>
